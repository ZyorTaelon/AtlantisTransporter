-- install this file with: wget -f 'https://raw.githubusercontent.com/ZyorTaelon/OpenComputersPrograms/master/Atlantis/Transporter/setup.lua'
local os = require('os');
...
local srcFileName = '/Atlantis/Transporter/downloadCode.lua'
